...
//! Vendored Zig 0.16.0 test runner for builtin fuzzing.
//! Temporary workaround: use writeErrorReturnTrace for @errorReturnTrace().
//! Remove when the toolchain ships this fix.
